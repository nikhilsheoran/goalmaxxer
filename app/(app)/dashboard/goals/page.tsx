...
const sortGoalsByPriority = (
  ...
  return [...goals].sort((a, b) => {
    ...
    const priorityComparison =
      (priorityMap[aPriority as keyof typeof priorityMap] ?? 999) -
      (priorityMap[bPriority as keyof typeof priorityMap] ?? 999);
    ...
    <div className="space-y-8">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground text-lg">
          Track and manage your progress towards financial goals.
        </p>
      </div>
                ...
                <CardContent className="px-4 py-2 pt-0">
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="flex-1 space-y-4">
                      <div className="flex flex-col md:flex-row justify-between gap-2 md:items-center">
                        <div className="space-y-1">
                          ...
                          <p className="text-lg font-semibold">
                            {formatCurrency(goal.currentAmt)}
                          </p>
                        </div>
                      ...
                      {goal.currentAmt < goal.targetAmt * 0.5 &&
